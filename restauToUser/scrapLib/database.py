...
def upload_restau(infos: dict, db, cursor: CMySQLCursor) -> bool:
    ...
    :return: True if the upload is a success
    """
    table = "restaurant"
...
def get_column_from_table(column: str, table: str, cursor: CMySQLCursor, order_by: str = None, conditions: str = None, limit: int = None) -> list:
    """
